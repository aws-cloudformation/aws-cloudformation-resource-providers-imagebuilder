                ...
                Distribution.builder()
                        ...
                        .amiDistributionConfiguration(AmiDistributionConfiguration.builder()
                                ...
                                .launchPermission(LaunchPermissionConfiguration.builder()
                                        ...
                                        .organizationArns(ImmutableList.of("org-arn-1"))
                                        .organizationalUnitArns(ImmutableList.of("org-unit-arn-1"))
                                        .build())
                ...
                Distribution.builder()
                        ...
                        .amiDistributionConfiguration(AmiDistributionConfiguration.builder()
                                ...
                                .launchPermission(LaunchPermissionConfiguration.builder()
                                        ...
                                        .organizationArns(ImmutableList.of("org-arn-2"))
                                        .organizationalUnitArns(ImmutableList.of("org-unit-arn-2"))
                                        .build())
